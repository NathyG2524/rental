...
export class UpdateOnDepartmentTeams1721637152248
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "project_tasks" RENAME COLUMN "projectTeamId" TO "departmentTeamId"`,
    );
    await queryRunner.query(
      `CREATE TABLE "department_teams" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "departmentId" uuid, "projectsId" uuid, "departmentTasksId" uuid, CONSTRAINT "PK_22d27e77d42e53539523fcb5899" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "projects" ADD "departmentTeamId" uuid NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "project_tasks" ADD CONSTRAINT "FK_22d56ec0331ec0716ad9c4231f1" FOREIGN KEY ("departmentTeamId") REFERENCES "department_teams"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "project_tasks" DROP CONSTRAINT "FK_22d56ec0331ec0716ad9c4231f1"`,
    );
    await queryRunner.query(
      `ALTER TABLE "projects" DROP COLUMN "departmentTeamId"`,
    );
    await queryRunner.query(`DROP TABLE "department_teams"`);
    await queryRunner.query(
      `ALTER TABLE "project_tasks" RENAME COLUMN "departmentTeamId" TO "projectTeamId"`,
    );
    await queryRunner.query(
