...
export class UpdateOnAccountReceivableDetail1727267768717
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "account_receivable_details" DROP COLUMN "unit"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "account_receivable_details" DROP COLUMN "name"`,
    );
    await queryRunner.query(
      `ALTER TABLE "account_receivable_details" ADD "dueDate" TIMESTAMP NOT NULL`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "account_receivable_details" DROP COLUMN "dueDate"`,
    );
    await queryRunner.query(
      `ALTER TABLE "account_receivable_details" ADD "name" character varying NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "account_receivable_details" ADD "unit" numeric NOT NULL`,
    );
    await queryRunner.query(
